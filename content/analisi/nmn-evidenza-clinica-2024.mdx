...
<FieldNote>
Ho seguito personalmente la letteratura sull'NMN per oltre un anno, leggendo ogni nuovo trial appena pubblicato. La sensazione, fonti alla mano, è chiara: i numeri sul NAD⁺ ematico sono reali e ripetibili, ma il salto logico "più NAD⁺ = vivi meglio/più a lungo" non è ancora dimostrato nell'uomo. È il motivo per cui qui trovi un grado B e non un entusiasmo da brochure.
</FieldNote>
